      ...
      <section className="container py-12 md:py-20 lg:py-28 relative z-10">
        <div className="text-center space-y-6 md:space-y-8">
          ...
          <p className="text-base md:text-lg max-w-4xl mx-auto leading-relaxed">
            Прокачай одну ключевую профессию на ИИ и выйди на чеки от 1500–5000 $ за
            проекты в новых нишах, запуски без таргета и бесконечных прогревов и новый уровень дохода
          </p>
